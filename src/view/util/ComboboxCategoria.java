...
public class ComboboxCategoria {
    ...
    public static void preencheComboBoxCategoria(int SelCodigo, JComboBox combo, ArrayList<Categoria> lista, Boolean addTodos){
        ...
        if (addTodos)
            vlista.add(new ComboboxCategoria(0,"Todas"));
